...
<body>
    <div class="container">
        ...
        <h1>Bonjour,</h1>
        <h2></h2>
        <p class="message">Merci pour votre inscription. Cliquez sur le lien ci-dessous pour vérifier votre adresse e-mail :</p>
        <p>
        <div class="otp-box"><a href="{{ url('/verify-email/'.$token) }}">Vérifier mon e-mail</a></div>
