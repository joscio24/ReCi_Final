...
<!-- title -->
@section('title') RéCi| Économie et développement @endSection

<!-- content -->
@section('content')
@include('layouts.header2', ['header_title' => 'Économie et développement', 'header_subtitle' => 'Croissance économique, emploi, investissements et inégalités.' ])
...
<div class="section">
    <div class="post-sections mb-4">
        <div class="container my-5 ">
            ...
            <x-section-title text="Les débats sur l'Économie et développement:" />
            <div class="row">
