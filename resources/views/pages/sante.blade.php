...
<!-- title -->
@section('title') RéCi| Santé publique @endSection

<!-- content -->
@section('content')
@include('layouts.header2', ['header_title' => 'Santé publique', 'header_subtitle' => 'Politiques de santé, couverture médicale universelle, systèmes de soins.' ])
...
<div class="section">
    <div class="post-sections mb-4">
        <div class="container my-5 ">
            ...
            <x-section-title text="Les débats sur la santé:" />
            <div class="row">
