...
<!-- title -->
@section('title') RéCi| Droits humains et citoyenneté @endSection

<!-- content -->
@section('content')
@include('layouts.header2', ['header_title' => 'Droits humains et citoyenneté', 'header_subtitle' => "Justice sociale, droits civils, participation citoyenne." ])
...
<div class="section">
    <div class="post-sections mb-4">
        <div class="container my-5 ">
            ...
            <x-section-title text="Les débats sur Droits humains et citoyenneté" />
            <div class="row">
