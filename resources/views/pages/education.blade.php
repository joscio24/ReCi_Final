...
<!-- title -->
@section('title') RéCi| Education @endSection

<!-- content -->
@section('content')
@include('layouts.header2', ['header_title' => 'Education', 'header_subtitle' => "Accès à l’éducation, innovations pédagogiques, réformes éducatives." ])
...
<div class="section">
    <div class="post-sections mb-4">
        <div class="container my-5 ">
            ...
            <x-section-title text="Les débats sur l'éducation':" />
            <div class="row">
