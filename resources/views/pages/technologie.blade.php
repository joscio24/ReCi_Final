...
<!-- title -->
@section('title') RéCi| Technologie et innovation @endSection

<!-- content -->
@section('content')
@include('layouts.header2', ['header_title' => 'Technologie et innovation', 'header_subtitle' => "Transformation digitale, infrastructures numériques, et soutien aux startups." ])
...
<div class="section">
    <div class="post-sections mb-4">
        <div class="container my-5 ">
            ...
            <x-section-title text="Les débats sur la Technologie et innovation" />
            <div class="row">
